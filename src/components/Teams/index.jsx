...
<section id="team" ref={container}>
        <div className="container">
            ...
            <h3 className="sub__title">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt dolorem quisquam nisi sint quam tenetur. Laboriosam
                 distinctio consequuntur architecto, odit explicabo ab pariatur impedit iusto, dolores facere tempore laudantium saepe.
            </h3>
                ...
                teams.map((team,index) => (
                    <div className="team__card" key={index}>
                        ...
                        <div className="details">
                            ...
                            <p className="text__muted">{team.experience}</p>
